...
def main():
    ...
    parser.add_argument('--tracker_param', type=str, default='multi-hivit-ep150-4frames', help='Name of config file.')
    parser.add_argument('--save_name', type=str, default='AQATrack_300-debug', help='Name of save file.')
